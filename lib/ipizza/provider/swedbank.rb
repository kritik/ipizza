module Ipizza::Provider
  class Swedbank
    ...
    def payment_response(params)
      ...
      response.verify(self.class.file_cert, self.class.encoding, self.class.encoding, {'bank_type' => 'swedbank'})
      return response
    end
    ...
    def authentication_response(params)
      response = Ipizza::AuthenticationResponse.new(params, {'bank_type' => 'swedbank'})
